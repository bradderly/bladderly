...
import 'package:bladderly/presentation/feature/symptom/survey/symptom_survey_view.dart';
import 'package:flutter/widgets.dart';
// Package imports:
import 'package:flutter_bloc/flutter_bloc.dart';

class SymptomSurveyBuilder extends StatelessWidget {
  const SymptomSurveyBuilder({super.key, required this.scoreType});
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<SymptomSurveyFormCubit>(
          create: (_) =>
              SymptomSurveyFormCubit(questionCount: SymptomSurveyModel.getByScoreType(scoreType).questions.length),
        ),
      ],
      child: SymptomSurveyView(symptomSurveyModel: SymptomSurveyModel.getByScoreType(scoreType)),
    );
  }
}
