...
class SoundInputRecordingBuilder extends StatefulWidget {
  const SoundInputRecordingBuilder({super.key});

  @override
  State<SoundInputRecordingBuilder> createState() => _SoundInputRecordingBuilderState();
}

class _SoundInputRecordingBuilderState extends State<SoundInputRecordingBuilder> {
  final recorder = getIt<Recorder>();
